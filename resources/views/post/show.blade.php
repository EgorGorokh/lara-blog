...
<main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{$post->comments->count()}} комментариев</p>
...
@endif
                    ...
                    <section class="comment-list mb-5">
                        <div class="mb-5"> Комментарии:</div>
...
@endforeach
                    ...
                    <section class="comment-section">
                        <h2 class="section-title mb-5" data-aos="fade-up"> Отправить комментарий
